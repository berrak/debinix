...
FULL_VERSION = find_version('debinix/__init__.py')
# Short X.Y version.
...
setup(
    ...
    package_dir={'debinix': 'debinix'},
    entry_points={
        'console_scripts': [
            'debinix = debinix.cli:main',
        ]
    },
    ...
    author_email='bertil.kronlund@debinix.org',
    url='https://github.com/berrak/debinix',
